...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_integer("image_number", 9367, "Number of images in your tfrecord, default is 9367.") #was 300, Ammar
flags.DEFINE_integer("class_number", 15, "Number of class in your dataset/label.txt, default is 15.")
flags.DEFINE_integer("image_height", 45, "Height of the output image after crop and resize. Default is 45.") #was 299 ,Ammar
flags.DEFINE_integer("image_width", 60, "Width of the output image after crop and resize. Default is 60.") # was 299, Ammar
...
def read_and_decode(filename_queue):
    ...
    current_image_object.image = tf.image.resize_image_with_crop_or_pad(image_raw, FLAGS.image_height, FLAGS.image_width) #Ammar: was: tf.image.resize_image_with_crop_or_pad(image_raw, FLAGS.image_height, FLAGS.image_width) # cropped image with size 299x299
...
print("cd to current directory, the folder 'resized_image' should contains %d images with %dx%d size." % (FLAGS.image_number, FLAGS.image_width ,FLAGS.image_height))
